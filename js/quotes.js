const quotes = [
    ...
    {
        quote: "변화는 우리가 누군가나 무엇, 혹은 후일을 기다린다고 찾아오지 않는다. 우리 자신이 기다리던 사람이고 우리가 바로 추구하는 변화이다.",
        author: "버락 오바마",
    },
    {
    ...
    {
        quote: "새로운 일에 도전하다 보면 가끔 실수를 저지룰 수 있다. 자신의 실수를 빨리 인정하고 다른 시도에 집중하는 것이 최선이다.",
        author: "스티브 잡스",
    },
    {
    ...
    {
        quote: "용기란 죽을만큼 두려워도 무언가 해 보는 것이다.",
        author: "존 웨인",
    },
    {
        quote: "절대로 고개를 떨구지 말라. 고개를 꼿꼿이 치켜 들고 두 눈으로 똑똑이 세상을 보라.",
        author: "헬렌 켈러",
    },
    {
        quote: "무언가를 위해 죽을 각오가 없다면, 인생을 살게 해 줄 무언가도 가질 수 없을 것이다.",
        author: "체게바라",
    },
    {
        quote: "승리는 가장 끈기 있는 세상에게 돌아간다.",
        author: "보나파르트 나폴레옹",
    },
    {
    ...
    {
        quote: "인생에서 실패한 사람의 대부분은 성공이 눈 앞에 왔는데도 모르고 포기한 사람이다.",
        author: "토마스 에디슨",
    },
    {
    ...
    {
        quote: "네가 누구인지, 무엇인지 말 해줄 사람은 필요 없다. 너는 그냥 너 자신일 뿐이다.",
        author: "존 레논",
    },
    {
